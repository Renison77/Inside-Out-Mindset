...
const Footer = () => {
   return (
      <footer className="bg-primary-950 text-neutral-500 border-t border-primary-900 pt-20 pb-10 text-sm">
         <div className="max-w-[1200px] mx-auto px-4 md:px-6">
            ...
            <div className="border-t border-primary-900 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
               ...
               <p className="text-xs max-w-2xl text-center md:text-left leading-relaxed opacity-60">
                  <span className="font-bold text-neutral-400 block mb-2">Disclaimer</span>
