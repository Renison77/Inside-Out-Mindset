...
const Advisory = () => {
   return (
      <section id="advisory" className="py-24 bg-blue-50 relative overflow-hidden border-t border-slate-200">
         <div className="max-w-[1200px] mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <Reveal>
               <div className="w-16 h-16 bg-white border border-slate-100 rounded-sm flex items-center justify-center text-amber-600 mb-8 shadow-sm">
                  <Building2 size={32} />
               </div>
               <h2 className="text-xs font-bold text-amber-600 uppercase tracking-[0.3em] mb-4">Advisory & Strategy</h2>
               <h3 className="text-3xl md:text-5xl font-sans font-medium text-navy-900 mb-6 leading-tight">
                  Advisory for <span className="text-slate-500 italic font-serif">Organizations</span> <br />and <span className="text-slate-500 italic font-serif">Government</span>
               </h3>
               ...
               <button
                  ...
                  className="inline-flex items-center gap-3 text-navy-900 border-b border-amber-600 pb-1 hover:text-amber-600 transition-colors uppercase tracking-widest text-sm font-bold"
               >
            ...
            <Reveal delay={0.2}>
               <div className="bg-white border border-slate-100 p-8 md:p-10 rounded-sm shadow-xl relative">
