...
const Card = ({ item, index }) => {
   ...
   return (
      <motion.div
         ...
         className={`relative w-full cursor-pointer transition-all duration-500 ease-in-out ${isExpanded ? 'h-[600px] md:h-[550px]' : 'h-[480px]'}`}
      >
         <div className={`absolute inset-0 w-full h-full bg-white border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-500 rounded-sm overflow-hidden flex flex-col ${isExpanded ? 'ring-2 ring-amber-500 ring-offset-4 ring-offset-slate-50' : ''}`}>
            ...
            <div className="p-8 md:p-10 relative z-10 bg-white">
               ...
               <h3 className="text-3xl font-sans font-medium text-navy-900 leading-tight mb-4">{item.title}</h3>
            ...
            <AnimatePresence>
               {isExpanded && (
                  <motion.div
                     ...
                     className="bg-navy-900 text-white flex-1 p-8 md:p-10 flex flex-col justify-center relative overflow-hidden"
                  >
            ...
            <div className={`absolute bottom-0 left-0 w-full py-4 px-8 md:px-10 border-t transition-colors duration-300 flex justify-between items-center ${isExpanded ? 'bg-navy-950 border-navy-900 text-white' : 'bg-slate-50 border-slate-100 text-slate-500 group-hover:bg-amber-50'}`}>
   ...
   return (
      <section id="talks" className="py-24 md:py-32 bg-slate-50 relative scroll-mt-20">
         <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="mb-20 flex flex-col md:flex-row justify-between items-end gap-10 border-b border-slate-200 pb-10">
               <div className="max-w-2xl">
                  <Reveal>
                     ...
                     <h2 className="text-5xl md:text-6xl font-sans font-medium text-navy-900 tracking-tight leading-[1]">
                        Choose Your <br />
               ...
               <Reveal delay={0.2}>
                  <p className="text-right text-slate-500 text-sm max-w-xs leading-relaxed">
                     ...
                     <br /><span className="text-xs font-bold uppercase tracking-widest text-navy-900 mt-2 block opacity-50">Tap cards to view outcomes</span>
                  </p>
               </Reveal>
            </div>
