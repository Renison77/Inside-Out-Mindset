               ...
               {media.map((item, i) => (
                  <Reveal delay={i * 0.2} key={i}>
                     <div className="group cursor-pointer">
                        <div className="relative overflow-hidden rounded-sm aspect-video mb-4 bg-navy-900 shadow-xl">
                           ...
                           <div className="absolute inset-0 flex items-center justify-center z-20">
                              <div className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30 group-hover:bg-amber-500 group-hover:border-amber-500 transition-all">
                                 <Play size={24} className="text-white ml-1" fill="currentColor" />
                              </div>
                           </div>
                        </div>
                        <h4 className="text-lg font-bold text-navy-900 group-hover:text-amber-600 transition-colors">{item.title}</h4>
