         ...
         <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="text-center mb-16">
               <Reveal>
                  ...
                  <h2 className="text-4xl md:text-5xl font-serif text-white mb-6">What people are saying</h2>
               </Reveal>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
               {quotes.map((quote, i) => (
                  <Reveal delay={i * 0.1} key={i}>
                     <div className="bg-navy-800/40 p-6 rounded-sm border border-white/5 hover:bg-navy-800 hover:border-amber-500/20 transition-all h-full flex flex-col justify-between">
                        <p className="text-slate-300 font-light italic text-sm leading-relaxed mb-4">"{quote.text}"</p>
                        <p className="text-xs font-bold uppercase tracking-widest text-amber-600 border-t border-white/5 pt-4">{quote.author}</p>
                     </div>
                  </Reveal>
               ))}
            </div>
